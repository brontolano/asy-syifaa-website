...
<head>
  ...
  <title>Pengumuman - Asy-Syifaa Wal Mahmuudiyyah</title>
...
<main class="blog-shell" id="blogPageRoot" data-mode="list" data-filter-type="general">
  <section class="container">
    <div class="blog-hero">
      <span class="blog-badge"><i class="fa-solid fa-bullhorn"></i> Informasi Resmi</span>
      <h1>Pengumuman Pesantren</h1>
      <p class="mb-0">Informasi umum, agenda resmi, dan pemberitahuan penting untuk santri, wali, dan asatidz.</p>
    </div>
    <p id="blogLoading" class="text-muted">Memuat pengumuman...</p>
    <div id="blogList" class="blog-grid"></div>
    <div id="blogEmpty" class="blog-empty d-none mt-3">Belum ada pengumuman aktif.</div>
  </section>
</main>
