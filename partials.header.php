  ...
  <div class="container-fluid px-3 px-xl-4">
    ...
    <div class="collapse navbar-collapse" id="asfPublicNavbar">
      ...
      <ul class="navbar-nav ms-xl-3 asf-public-navbar-right">
        ...
        <?php else: ?>
          <li class="nav-item" id="loginNavItem"><a class="nav-link" href="https://pesantren.asy-syifaa.com/" id="apps-erp-link"><i class="fa-solid fa-right-to-bracket"></i> Login / Signup</a></li>
        <?php endif; ?>
